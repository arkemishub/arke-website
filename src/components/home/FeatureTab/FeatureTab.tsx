  ...
  return (
    ...
    >
      <button
        ...
        className={twMerge(
          `mx-4 lg:mx-6`,
          active === 0 ? "text-primary" : "text-secondary"
        )}
      >
        Backend
      </button>
      ...
      <button
        ...
        className={twMerge(
          `mx-4 lg:mx-6`,
          active === 1 ? "text-primary" : "text-secondary"
        )}
      >
        Frontend
      </button>
      ...
      <button
        ...
        className={twMerge(
          `mx-4 lg:mx-6`,
          active === 2 ? "text-primary" : "text-secondary"
        )}
      >
        Console
      </button>
      <div
        className={`feature-tab-border-gradient feature-tab-${color}`}
        style={
          active === 0
            ? { marginLeft: 0 }
            : active === 1
