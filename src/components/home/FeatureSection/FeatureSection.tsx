    ...
    return(
        <>
            ...
            <div className="px-4 md:px-12 grid gap-x-4 gap-y-4 md:grid-cols-2 lg:grid-cols-4 h-20">
                ...
                {active === 0 &&
                    <>
                        <FeatureCard title="Powerful Elixir core"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_elixir.png`}/>
                        <FeatureCard title="Pluggable database"
                        ...
                        <FeatureCard title="Auto-generated REST APIs"
                ...
                {active === 1 &&
                    <>
                        <FeatureCard title="Swift backend connection"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_swift_connection.png`}/>
                        <FeatureCard title="Automatic layout builder"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_builder.png`}/>
                        <FeatureCard title="Customized UI components"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_customizable.png`}/>
                        <FeatureCard title="Headless forms & tables"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_headless.png`}/>
                    </>
                }
                {/* Console */}
                {active === 2 &&
                    <>
                        <FeatureCard title="Intuitive project management"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_project_management.png`}/>
                        <FeatureCard title="Dynamic prototyping"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_prototyping.png`}/>
                        <FeatureCard title="Smart code sync"
                                     img={`${import.meta.env.BASE_URL}/features/square/feature_smart_code_sync.png`}/>
                        <FeatureCard title="Add-ons & integrations"
